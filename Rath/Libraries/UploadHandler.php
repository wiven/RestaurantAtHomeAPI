...
class UploadHandler
{
    ...
    function __construct($options = null, $initialize = false, $error_messages = null) {
        ...
        $this->options = array(
            ...
            'readfile_chunk_size' => 5 * 1024 * 1024, // 10 MiB
            ...
            */
            ...
            'print_response' => true //TODO: change to false
        );
        if ($options) {
...
//                break;
    ...
    public function get_download_url($file_name, $version = null, $direct = false) {
    ...
    public function post($print_response = true) {
        ...
        $file_name = hash("md5",Authorization::$userId. General::getCurrentDateTime() .$this->options["link_id"]);
